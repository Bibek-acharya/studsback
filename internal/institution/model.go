...
type InstitutionEntrance struct {
	...
	ExamMode               string         `gorm:"default:''" json:"exam_mode"`
	ExamScope              string         `gorm:"default:''" json:"exam_scope"`
...
type InstitutionUser struct {
	...
	RegistrationNumber *string        `gorm:"uniqueIndex;default:null" json:"registration_number"`
