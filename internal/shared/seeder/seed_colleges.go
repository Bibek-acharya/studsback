...
func applyProfileFitDefaults(college *college.College) {
...
func SeedCollegeUniversityCourseMappings(db *gorm.DB) error {
	...
	mappings := []mappingSeed{
		...
		{College: "Prithvi Narayan Campus", University: "Tribhuvan University", Course: "B.Sc CSIT (Computer Science & IT)", Status: "ongoing"},
		...
		{College: "Lalit Multiple Campus", University: "Tribhuvan University", Course: "B.Sc CSIT (Computer Science & IT)", Status: "ongoing"},
		...
		{College: "Birendra Multiple Campus", University: "Tribhuvan University", Course: "B.Sc CSIT (Computer Science & IT)", Status: "ongoing"},
	...
	for _, item := range mappings {
		...
		relation := education.CollegeUniversityCourse{
			CollegeID:    collegeID,
	...
	for _, course := range courses {
		...
		if err := db.Model(&education.CollegeUniversityCourse{}).
			Distinct("college_id").
		...
		if err := db.Model(&education.Course{}).
			Where("id = ?", course.ID).
