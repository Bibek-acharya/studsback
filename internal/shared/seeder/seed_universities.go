...
func SeedUniversities(db *gorm.DB) error {
	universities := []university.University{
		...
		},
		{
			...
			Logo:        "https://ui-avatars.com/api/?name=PuU&background=2563eb&color=fff",
			Location:    "Biratnagar, Morang",
			Type:        "Public",
			Rank:        4,
			Popular:     false,
			Description: "A regional public university serving eastern Nepal with broad academic and affiliated college coverage.",
			Established: "1995",
			Website:     "purbuniv.edu.np",
		},
		{
			Name:        "Mid-Western University",
			Logo:        "https://ui-avatars.com/api/?name=MWU&background=0f766e&color=fff",
			Location:    "Birendranagar, Surkhet",
			Type:        "Public",
			Rank:        5,
			Popular:     false,
			Description: "A public university focused on expanding higher education access in western Nepal.",
			Established: "2010",
			Website:     "mwu.edu.np",
		},
		{
			Name:        "Far-Western University",
			Logo:        "https://ui-avatars.com/api/?name=FWU&background=1d4ed8&color=fff",
			Location:    "Mahendranagar, Kanchanpur",
			Type:        "Public",
			Rank:        6,
			Popular:     false,
			Description: "A public university established to serve the far-western region with accessible higher education.",
			Established: "2010",
			Website:     "fwu.edu.np",
		},
		{
			Name:        "Agriculture & Forestry University",
			Logo:        "https://ui-avatars.com/api/?name=AFU&background=15803d&color=fff",
			Location:    "Rampur, Chitwan",
			Type:        "Public",
			Rank:        7,
			Popular:     false,
			Description: "A specialized public university for agriculture, forestry, and applied sciences.",
			Established: "2010",
			Website:     "afu.edu.np",
		},
		{
		...
		},
		{
			...
			Logo:        "https://ui-avatars.com/api/?name=LU&background=7c3aed&color=fff",
			Location:    "Auckland, New Zealand",
			Type:        "Private",
			Rank:        8,
			Popular:     false,
			Description: "A modern university often referenced by international-affiliated pathway programs.",
			Established: "1990",
			Website:     "lincoln.ac.nz",
		},
		{
