...
func testDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&AccountNotification{}, &NotificationOutbox{}, &NotificationBroadcast{}, &NotificationDedupeLease{}); err != nil {
	...
	t.Cleanup(func() {
		db.Exec(`TRUNCATE account_notifications, notification_outbox, notification_broadcasts, notification_dedupe_leases`)
	})
	return db
}
