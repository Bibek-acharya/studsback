...
func SeedScholarships(db *gorm.DB) error {
	...
	if count > 0 {
		if err := db.Unscoped().Where("1 = 1").Delete(&models.ScholarshipApplication{}).Error; err != nil {
			return err
		}
		if err := db.Unscoped().Where("1 = 1").Delete(&models.Scholarship{}).Error; err != nil {
			return err
		}
	}
	...
	scholarships := []models.Scholarship{
		...
		},
		{
			...
			ImageURL:          "https://images.unsplash.com/photo-1573166368361-3f5231646f25?q=80&w=2069&auto=format&fit=crop",
