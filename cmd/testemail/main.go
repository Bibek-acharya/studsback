...
func main() {
	...
	to := "durgeshbhandari834@gmail.com"
	otp := "789123"

	// Get the proper OTP email template with API logo endpoint
	subject := "Your StudSphere Verification Code"

	// Create the email body using the actual template
	logoURL := emailqueue.GetStudSphereLogoURL() // Now returns API endpoint
...
<body>
    <div class="email-container">
        <div class="header">
            <div class="brand-logo">
                <img src="%s" alt="Studsphere" style="max-width: 150px; height: auto;">
            </div>
	...
	log.Printf("Attempting to send to %s via %s", to, addr)
	...
	log.Printf("SUCCESS: Email sent to %s with OTP: %s!", to, otp)
}
